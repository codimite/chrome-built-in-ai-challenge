                ...
                try {
                    ...
                    chrome.storage.sync.get(['disabledWebsites'], (result) => {
                        ...
                        if (isCurrentlyDisabled) {
                            ...
                            const updatedList = disabledWebsites.filter(
                ...
                {areAllApisReady ? (
                    <>
                        ...
                        <Text size="xs" fw={400} mb={'xs'}>
                            IntelliWrite is an advanced AI-powered tool that helps you easily
                            rewrite content while protecting sensitive information.
                        </Text>
                    ...
                    <>
                        ...
                        <Text size="xs" fw={400} mb={'xs'}>
                            Please click on "Learn how to enable" to activate the required flags in
                            chrome://flags
                        </Text>
