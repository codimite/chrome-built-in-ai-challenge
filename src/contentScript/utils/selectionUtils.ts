 ...
 */
export function getCursorPositionForContentEditable(selection: Selection): {
    x: number
    y: number
} {
    let x = 0
 ...
 */
export function getCaretCoordinatesInInput(element: HTMLInputElement | HTMLTextAreaElement): {
    x: number
    y: number
} {
